          ...
          <div className="space-y-4">
            ...
            {!emailProvider && (
              <div className="text-center py-4">
                <p className="text-sm text-[var(--app-text-secondary)] mb-3">
                  Want to try the interface first? You can add some demo emails to test the swipe
                  functionality.
                </p>
                <Button
                  onClick={() => {
                    ...
                    fetch('/api/seed', { method: 'POST' })
                      .then(() => {
                        ...
                        toast({
                          ...
                          description:
                            'Try swiping through the sample emails in the main interface.',
                        });
                      })
                      .catch(() => {
                        toast({
            ...
            <div className="bg-amber-50 p-4 rounded-lg">
              ...
              {emailProvider === 'yahoo' && (
                <div className="mb-3 p-3 bg-white rounded border-l-4 border-yellow-500">
                  ...
                  <ol className="text-sm text-[var(--app-text-secondary)] space-y-1 list-decimal list-inside">
                    ...
                    <li>
                      Use the generated 16-character password above (not your regular password)
                    </li>
                  </ol>
                  <p className="text-xs text-[var(--app-text-secondary)] mt-2">
                    <strong>Note:</strong> Yahoo requires 2-step verification to be enabled before
                    you can create app passwords.
                  </p>
                </div>
              )}
              ...
              <ul className="text-sm text-[var(--app-text-secondary)] space-y-1">
                <li>
                  • <strong>Never use your regular email password</strong> - always use app-specific
                  passwords
                </li>
