            ...
            <div className="flex-1 space-y-3">
              {highPriorityEmails.length > 0 ? (
                highPriorityEmails.map((email) => (
                  <div
                    key={email.id}
                    className="bg-white/5 border border-white/5 hover:border-white/10 p-4 rounded-2xl transition-all cursor-pointer group/item"
                  >
                    <div className="flex justify-between items-start mb-1">
                      <span className="text-[10px] font-bold text-orange-500/80 uppercase tracking-widest leading-none">
                        High Priority
                      </span>
                ...
                <div className="h-full flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-[10px] text-gray-600 uppercase mt-1 tracking-widest font-bold">
                    Good work!
                  </p>
                </div>
              )}
        ...
        <motion.div variants={item}>
          <div className="app-shell-panel h-full flex flex-col bg-gradient-to-b from-[#111] to-[#0a0a0a]">
            ...
            <div className="flex-1 flex flex-col items-center justify-center">
              ...
              <p className="text-[10px] text-gray-600 uppercase tracking-[0.2em] font-bold mt-4">
                Last 12 Weeks
              </p>
            </div>
          ...
          <div className="app-shell-panel bg-[#161616] border-orange-500/10 border-t-2">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white tracking-wide italic underline decoration-orange-500/30">
                    Reflection Planner
                  </h3>
                  <p className="text-sm text-gray-500 mt-1 max-w-md">
                    Capture today's learnings and emotional peaks to close your daily loop.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6">
                <div className="hidden md:block text-right">
                  ...
                  <Badge
                    variant={todayEntry ? 'default' : 'outline'}
                    className={
                      todayEntry ? 'bg-emerald-500/20 text-emerald-400 mt-1' : 'text-gray-600 mt-1'
                    }
                  >
