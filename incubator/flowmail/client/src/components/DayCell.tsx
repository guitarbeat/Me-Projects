...
const DayCell: React.FC<DayCellProps> = React.memo(
  ({
    ...
    const style: React.CSSProperties = {
      ...
      color:
        (item.intensity && item.intensity >= 3) || active
          ? 'white'
          : 'var(--color-text)',
      fontWeight: 'bold',
      userSelect: 'none',
      ...
      boxShadow:
        active || selected
          ? '0 0 0 2px var(--color-bg), 0 0 0 4px var(--color-fill)'
          : 'none',
      lineHeight: 1,
      textAlign: 'center',
      whiteSpace: 'pre-line',
      transition:
        'background-color 0.2s ease, transform 0.1s ease, border-radius 0.3s ease',
              ...
              case 'full':
                ...
                return (
                  <>
                    ...
                    <div style={{ fontSize: '0.6em', opacity: 0.7 }}>
                      W{item.weekIndex}
                    </div>
                  </>
                );
