...
![Billy Bathroom](./images/billy_bathroom.jpeg)
![Billy UI](./images/web-UI.png)
<img src="./images/web-UI-Mobile.png" alt="Billy UI Mobile" style="width: 33%;" />
---
...
See [BUILDME.md](./BUILDME.md) for detailed build/wiring instructions.
