# Repository Consolidation: Helios Billy Bass
...
The `helios-billy-bass` workspace now combines:
...
- Verification screenshots now live under `__tests__/` instead of the repository root.
