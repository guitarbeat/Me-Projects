...
Consolidated animatronics workspace (`apps/helios-billy-bass`) for Big Mouth Billy Bass firmware, assistant tooling, and shared hardware resources.
...
- `__tests__/` - saved screenshots from verification runs
...
- Save verification screenshots under `__tests__/`.

## History

This monorepo replaces earlier fragmented Billy Bass repositories with a cleaner `projects/`, `shared/`, `docs/`, and `__tests__/` layout.
