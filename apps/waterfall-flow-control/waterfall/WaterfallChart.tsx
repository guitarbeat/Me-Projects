  ...
  ({ data, chartMode }: WaterfallChartProps) => {
    ...
    const waterfallData = useMemo(() => {
      if (chartMode === 'summary') {
        // ⚡ Bolt Performance Optimization: Single-pass O(N) loop replaces chained .filter/.reduce/.find and O(N²) .includes
        let totalIncome = 0;
        let incomeDate = '';
