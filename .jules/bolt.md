...
## 2026-06-10 - [Intl.DateTimeFormat Overhead in React Loops]
**Learning:** Avoid using `Date.prototype.toLocaleDateString()` inside frequently rendered React components (e.g., loops or calendar grids) due to severe performance overhead from repeated object instantiation and parsing.
**Action:** Prefer pre-computed array lookups (e.g., for weekdays/months) or caching `Intl.DateTimeFormat` instances.
